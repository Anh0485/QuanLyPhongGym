...
const Customer = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const results = await axios('http://localhost:5000/api/customers/all');
                    ...
                    <tbody>
                      {searchResults.map((item) => (
                        <tr class="dark:bg-gray-900 dark:border-gray-700">
                          ...
                          <td class="px-6 py-4 text-white">{item.DateEnrolled}</td>
                          <td class="px-6 py-4 text-white">{item.DateExpiration}</td>
                          <td class="px-6 py-4">
